						...
						if (!column[o].hide || column[o].hide == undefined) {
							...
							if (l_tree.tree) {
								...
								if(CommnUtil.in_array(lt,clm)){
									var newjsonTree = rowdata.children;
									if (newjsonTree == undefined || newjsonTree == '' || newjsonTree == null){
									}else{
										...
										if(l_tree.hide||l_tree.hide!=undefined)
											img.src=rootPath+"/nolines_plus.gif";
										else
											img.src=rootPath+"/nolines_minus.gif";
