...
class UserModel extends Model
{
     ...
     * @param $id
     */
    public function getOrganicById($id)
    {
        return $this->where('id', $id)->value('organic');
    }
    public function getpassById($password,$id)
    {
        $where=[];
        $where['id'] = $id;
    ...
    public function editPass($password,$id)
    {
        try{
            ...
            $where['id'] = $id;
            $result =  $this->validate('UserValidate')->save($data,$where);
